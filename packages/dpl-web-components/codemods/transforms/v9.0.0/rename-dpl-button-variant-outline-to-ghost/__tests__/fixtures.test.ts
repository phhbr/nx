/**
 * Golden / fixture-based tests for rename-dpl-button-variant-outline-to-ghost.
 *
...
describe('golden: variant rename — TSX component', () => {
  it('matches golden output', () => {
    goldenTest('component.input.tsx', 'component.output.tsx', 'component.tsx');
  });
});

describe('golden: variant rename — HTML template', () => {
  it('matches golden output', () => {
    goldenTest('template.input.html', 'template.output.html', 'template.html');
  });
});

describe('golden: variant rename — Vue SFC', () => {
  it('matches golden output', () => {
    goldenTest('sfc.input.vue', 'sfc.output.vue', 'component.vue');
  });
});
